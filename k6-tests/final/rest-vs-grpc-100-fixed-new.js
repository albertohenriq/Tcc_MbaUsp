...
grpcClient.load(['definitions'], 'process.proto');

export function setup() {
  console.log('Iniciando conexão gRPC...');
  grpcClient.connect('127.0.0.1:50052', {
    plaintext: true
  });
  console.log('Conexão gRPC estabelecida');
  return { grpcClient };
}
...
export default function (data) {
  ...
  try {
    const resGRPC = data.grpcClient.invoke('process.ProcessService/ProcessData', payload);
